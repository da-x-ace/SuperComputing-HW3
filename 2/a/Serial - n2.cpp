...
int main()
{
	...
	cout<<"value of n: "<<n<<endl;					//--- printing values of input
	cout<<"string1: ";
	for(i=0;i<n;i++)
	{
		cout<<s1[i];
	...
	cout<<endl;										//--- printing of i/p ends
	
	int D[n][n],G[n][n],I[n][n],u[n],v[n],se[n];
	int gi,ge,s,cost;
	gi=2;ge=1;
...
*/
	...
	cost=min1(D[n-1][n-1],I[n-1][n-1],G[n-1][n-1]);	
